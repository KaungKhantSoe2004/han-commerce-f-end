          ...
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <FaEnvelope className="flex-shrink-0 h-6 w-6 text-red-500 mt-1" />
              ...
              <div className="flex items-start">
                <FaPhone className="flex-shrink-0 h-6 w-6 text-red-500 mt-1" />
                <div className="ml-3 text-base">
              ...
              <div className="flex items-start">
                <FaMapMarkerAlt className="flex-shrink-0 h-6 w-6 text-red-500 mt-1" />
                <div className="ml-3 text-base">
